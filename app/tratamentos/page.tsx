            ...
            >
                ...
                <div className="relative z-10">
                    ...
                    <div className="container mx-auto px-4 py-12 text-center">
                        <h1 className="text-5xl font-bold mb-4">Tratamentos</h1>
                        <p className="text-lg text-slate-700">
                            MEDICINA FUNCIONAL INTEGRATIVA – <span className="font-bold">Diagnóstico e Tratamento</span>
                        </p>
                    </div>
                    <div className="flex flex-wrap gap-4 justify-start items-start p-4">
                        {tratamentos.map((tratamento) => (
                            <Tratamento key={tratamento.titulo} url={tratamento.url} titulo={tratamento.titulo} descricao={tratamento.descricao} />
                        ))}
                    </div>
                </div>
            </section>
